...
\titulo{MODELO DE APOIO AO ENSINO EM AMBIENTES VIRTUAIS DE
	APRENDIZAGEM SUSTENTADO POR CONSCIÊNCIA SITUACIONAL}
...
\nomeautorum{Ernani Augustinho}\sobrenomeautorum{Rodrigues Martins}
...
%%        será necessário editar o arquivo "tcc-ufvjm.cls".
\orientador{Claudia Beatriz Berti}
\ttorientador{Profa. Dra.}
\instorientador{UFVJM}

 \coorientador{Luciana Pereira de Assis}
 \ttcoorientador{Profa. Dra.}
 \instcoorientador{UFVJM}

\examinadorum{Alessandro Vivas Andrade}
\ttexaminadorum{Prof. Dr.}
\instexaminadorum{UFVJM}

\examinadordois{Luciana Pereira de Assis}
\ttexaminadordois{Profa. Dra.}
\instexaminadordois{UFVJM}
...
\include{capitulos/fundamentos-conceituais}
...
\bibliography{pos-textual/referencias/TCC}
...
%% RETIREI AUTORIZAÇÃO POR ENQUANTO
